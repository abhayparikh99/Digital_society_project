...
# for crypto error solve open your virtualenv -> (myenv)
# change the file name crypto to Crypto with upper case C because they import it as Crypto in every package.
# in my case E:\24_FEB_DJANGO\digitalsociety_env\Lib\site-packages\Crypto
# then install -> pip install pycryptodome
